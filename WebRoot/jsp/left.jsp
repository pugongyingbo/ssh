...
<body>
	<div class="col-sm-3 col-md-2 ">
		<ul class="nav nav-sidebar">
			...
			<li class="active" onmousedown="MM_showHideLayers('lefttwo','','show','leftthree','','hide','leftfour','','hide');
			this.style.color='red'"; onmouseout="this.style.color='black'" >
			<a>系统管理</a></li>
			
			<li onmousedown="MM_showHideLayers('lefttwo','','hide','leftthree','','show','leftfour','','hide');
			this.style.color='red'"; onmouseout="this.style.color='black'" >
			<a>收费管理</a></li>
			
			<li onmousedown="MM_showHideLayers('lefttwo','','hide','leftthree','','hide','leftfour','','show');
			this.style.color='red'"; onmouseout="this.style.color='black'" >
			<a>公司信息管理</a></li>
		</ul>
         <ul class="nav nav-sidebar" id="lefttwo">
					<li><a href="listallusers" target="content">系统账号管理</a>
					</li>
